...
CREATE TABLE IF NOT EXISTS `mydb`.`elevbokning` (
  ...
  `datum` DATE NULL,
  PRIMARY KEY (`lektionsID`, `personnummer`),
  UNIQUE INDEX `lektionsID_UNIQUE` (`lektionsID` ASC) VISIBLE,
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`rum` (`rumnummer`, `platser`) VALUES ('1', 2);
...
INSERT INTO `mydb`.`elevbokning` (`personnummer`, `lektionsID`, `syskonrabatt`, `datum`) VALUES ('201407062431', 3, 0, '2021-11-11');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`ensemble` (`lektionsID`, `genre`, `antalinstrument`) VALUES (3, 'jazz', 3);
